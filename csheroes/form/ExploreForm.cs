...
namespace csheroes.form
{
    public partial class ExploreForm : Form
    {
        ...
        void InitAction()
        {
            ...
            action[3, 6] = new Army(true, new Unit(UnitTemplate.COSMONAUT_RANGE), new Unit(UnitTemplate.COSMONAUT), new Unit(UnitTemplate.COSMONAUT), new Unit(UnitTemplate.COSMONAUT), new Unit(UnitTemplate.COSMONAUT), new Unit(UnitTemplate.COSMONAUT), new Unit(UnitTemplate.COSMONAUT_RANGE));
            action[3, 19] = new Army(true, new Unit(UnitTemplate.BOXER_ALI), new Unit(UnitTemplate.BOXER_STUDENT), new Unit(UnitTemplate.BOXER_STUDENT), new Unit(UnitTemplate.BOXER_STUDENT), new Unit(UnitTemplate.BOXER_STUDENT), new Unit(UnitTemplate.BOXER_STUDENT), new Unit(UnitTemplate.BOXER_ROCKY));
            action[9, 0] = new Army(true, new Unit(UnitTemplate.CREEP));
            action[13, 0] = new Army(true, new Unit(UnitTemplate.CREEP));
            action[11, 3] = new Army(true, new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP));
            action[9, 5] = new Army(true, new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP));
            action[13, 7] = new Army(true, new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP));
            action[13, 8] = new Army(true, new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP));
            action[9, 10] = new Army(true, new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP), new Unit(UnitTemplate.CREEP));
            action[12, 12] = new Army(true, new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE));
            action[11, 13] = new Army(true, new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE));
            action[9, 15] = new Army(true, new Unit(UnitTemplate.BITARD), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE));
            action[12, 18] = new Army(true, new Unit(UnitTemplate.BITARD), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE), new Unit(UnitTemplate.CREEP_RANGE));
            action[12, 18] = new Army(true, new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.PHILOSOPH_FAST), new Unit(UnitTemplate.PHILOSOPH_FAST));
            action[11, 19] = new Army(true, new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK), new Unit(UnitTemplate.WEAK));
            action[11, 22] = new Army(true, new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL), new Unit(UnitTemplate.NORMAL));
            action[20, 6] = new Army(true, new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE), new Unit(UnitTemplate.SOLDIER_RANGE));
            action[20, 19] = new Army(true, new Unit(UnitTemplate.MIGAS), new Unit(UnitTemplate.VANYA), new Unit(UnitTemplate.DIMA), new Unit(UnitTemplate.JULIA_B), new Unit(UnitTemplate.JULIA_S), new Unit(UnitTemplate.MISHA), new Unit(UnitTemplate.FEDOR));
        }
#endif
