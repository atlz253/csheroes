...
#elif TEST_BATTLE
            Application.Run(new BattleForm(null, new Hero(new Army(false, new Unit(100, 3, 1, AttackType.RANGE))), new Army(true, UnitFactory.GetUnitByTemplate(UnitTemplate.CREEP_RANGE)), new Rectangle(0, 0, Global.CellSize, Global.CellSize)));
#elif CAMPMENU
